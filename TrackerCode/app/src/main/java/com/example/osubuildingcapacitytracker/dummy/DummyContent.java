...
public class DummyContent {
    ...
    static {
        ...
        ITEMS.add(new DummyItem(Integer.toString(5),"Bolz Hall", new Integer(0),"2036 Neil Ave,\nColumbus, OH 43210", "default_no_logo.png", 200.0 ));
        ...
        ITEMS.add(new DummyItem(Integer.toString(13),"Smith Lab", new Integer(0),"174 W 18th Ave, \nColumbus, OH 43210", "default_no_logo.png", 200.0 ));
